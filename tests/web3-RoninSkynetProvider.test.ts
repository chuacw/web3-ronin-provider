...
describe('Accounts', () => {
  ...
  test('balance_of_address_and_contract', async () => {
    const account = '0x0addff455fca85f4cf54869fa224c804950cc06a';
    const contractAddr = Tokens.AXIE;
    const result = await provider.balance_of_address_and_contract(account, contractAddr);
...
describe('Blocks', () => {
  ...
  test('finalized_block_number', async () => {
    const result = await provider.finalized_block_number();
    expect(result.result.blockNumber).toBeGreaterThan(0);
  });

  test('latest_block_number', async () => {
    const result = await provider.latest_block_number();
    expect(result.result.blockNumber).toBeGreaterThan(0);
  });
  ...
  test('block_by_number', async () => {
    const block_number = 37493455;
    const result = await provider.block_by_number(block_number);
  ...
  test('block_by_hash_timestamp_block_number_range - no optional params', async () => {
    ...
    const result = await provider.block_by_hash_timestamp_block_number_range(fromBlock, toBlock);
  ...
  test('block_by_hash_timestamp_block_number_range - params hash', async () => {
    ...
    const timestamp = 1729489100;
    const fromBlock = 39216300; const toBlock = 39216311;
    const result = await provider.block_by_hash_timestamp_block_number_range(fromBlock, toBlock, { hash });
    const jsonResult = JSON.stringify(result);
  ...
  test('block_by_hash_timestamp_block_number_range - params timestamp', async () => {
    ...
    const timestamp = 1729489100;
    const fromBlock = 39216300; const toBlock = 39216311;
    const result = await provider.block_by_hash_timestamp_block_number_range(fromBlock, toBlock, { timestamp });
    const jsonResult = JSON.stringify(result);
  ...
  test('block_by_hash_timestamp_block_number_range - params timestamp and hash', async () => {
    ...
    const timestamp = 1729489100;
    const fromBlock = 39216300; const toBlock = 39216311;
    const result = await provider.block_by_hash_timestamp_block_number_range(fromBlock, toBlock, { timestamp, hash });
    const jsonResult = JSON.stringify(result);
...
describe('Collections', () => {
  ...
  test('owners_of_nft', async () => {
    ...
    const result = await provider.owners_of_nft(contract_addr, 3067049);
  ...
  test('token_transfers_of_nft', async () => {
    ...
    const result1 = await provider.token_transfers_of_nft(contract_addr, 1099511627776);
    expect(result1.result.items.length).toBeGreaterThanOrEqual(20);
  }, TIMEOUT);

  test('token_transfers_of_nft limit=2', async () => {
    const contract_addr = '0x12b707c3d2786570cfdc3a998a085b62acdba4b3';
    const result1 = await provider.token_transfers_of_nft(contract_addr, 1099511627776, 2);
    expect(result1.result.items.length).toBe(2);
  }, TIMEOUT);

  test('token_transfers_of_nft limit=2, nextCursor=...', async () => {
    const contract_addr = '0x12b707c3d2786570cfdc3a998a085b62acdba4b3';
    const result2 = await provider.token_transfers_of_nft(contract_addr, 1099511627776, 2, 'MzkxNjA1MTg6NTg6MTA5OTUxMTYyNzc3Ng==');
  ...
  test('detail_of_nft', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result = await provider.detail_of_nft(contract_addr, 3067049);
  ...
  test('refresh_nfts_of_collection_sync', async () => {
    ...
    const result = await provider.refresh_nfts_of_collection_sync(contractAddress, 0, tokenIds);
  ...
  test('details_of_multiple_nfts', async () => {
    ...
    const result = await provider.details_of_multiple_nfts(contract_addr, tokenIds);
  ...
  test('nfts_from_collection', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result = await provider.nfts_from_collection(contract_addr);
  ...
  test('number_of_collection_holdings_by_address', async () => {
    ...
    const result2 = await provider.number_of_collection_holdings_by_address(contract_addr, address);
  ...
  test('collection_holder_list', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result = await provider.collection_holder_list(contract_addr);
    expect(result.result.items.length).toBeGreaterThanOrEqual(20);
  }, TIMEOUT);

  test('collection_holder_list limit=3', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result1 = await provider.collection_holder_list(contract_addr, 3);
  ...
  test('collection_holder_list limit=4 paging=...', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result1 = await provider.collection_holder_list(contract_addr, 3);
    const result2 = await provider.collection_holder_list(contract_addr, 4, result1.result.paging.nextCursor);
  ...
  test('collection_token_transfers', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result = await provider.collection_token_transfers(contract_addr);
    expect(result.result.items.length).toBeGreaterThanOrEqual(20);
  }, TIMEOUT);

  test('collection_detail', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result = await provider.collection_detail(contract_addr);
  ...
  test('details_of_multiple_collections', async () => {
    ...
    const result = await provider.details_of_multiple_collections(contractAddresses);
...
describe('Contracts', () => {
  ...
  test('contract_detail', async () => {
    const contract_addr = '0x32950db2a7164ae833121501c797d79e7b79d74c';
    const result = await provider.contract_detail(contract_addr);
  ...
  test('multiple_contracts_details', async () => {
    ...
    const result = await provider.multiple_contracts_details(contract_addrs);
...
describe('Txs', () => {
  ...
  test('internal_txs', async () => {
    ...
    const result = await provider.internal_txs(txHash);
  ...
  test('internal_txs_detail', async () => {
    let txHash = '0xfbe5f6a0e8c57027cc97bb011120fcc12ea00b6bc6a45a7748c27d7f7e7756ba';
    const result = await provider.internal_txs_detail(txHash);
  ...
  test('multiple_txs_details', async () => {
    ...
    const result = await provider.multiple_txs_details(txHashes);
